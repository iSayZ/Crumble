...
INSERT INTO user(sex, firstname, lastname, country, birthdate, avatar) VALUES
("male", "John", "Doe", "FR", NOW(), "https://www.benouaiche.com/wp-content/uploads/2018/12/homme-medecine-chirurgie-esthetique-dr-benouaiche-paris.jpg"),
("female", "Jane", "Doe", "FR", NOW(), "https://img.freepik.com/photos-gratuite/portrait-jeune-femme_23-2148574874.jpg"),
("male", "Alexis", "Estrine", "FR", NOW(), "https://avatars.githubusercontent.com/u/121875319?v=4"),
("male", "Elon", "Musk", "US", NOW(), "https://cdn.futura-sciences.com/buildsv6/images/largeoriginal/d/9/a/d9a1058910_50163142_elon-musk1.jpg"),
("male", "Emmanuel", "Macron", "FR", NOW(), "https://upload.wikimedia.org/wikipedia/commons/thumb/c/c3/Emmanuel_Macron_%28cropped%29.jpg/170px-Emmanuel_Macron_%28cropped%29.jpg"),
("male", "Donald", "Trump", "US", NOW(), "https://upload.wikimedia.org/wikipedia/commons/thumb/5/56/Donald_Trump_official_portrait.jpg/640px-Donald_Trump_official_portrait.jpg"),
("male", "Kylian", "Mbappé", "FR", NOW(), "https://cdn-www.konbini.com/files/2024/06/masque_kylian.jpg?width=1920&quality=75&format=webp"),
("male", "Kim", "Jong-un", "FR", NOW(), "https://upload.wikimedia.org/wikipedia/commons/thumb/6/6e/Kim_Jong-un_April_2019_%28cropped%29.jpg/640px-Kim_Jong-un_April_2019_%28cropped%29.jpg");
...
INSERT INTO message (date_message, content, id_sender, id_recipient) VALUES
(NOW(), "Salut !", 3, 2);
