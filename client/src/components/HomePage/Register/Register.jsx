...
function Register() {
  ...
  const handleChangeConfPassword = (event) => {
    ...
    const handleChangeStep = () => {
      const values = formData.lastname !== "" && formData.firstname !== "" && formData.birthdate !== "" && formData.birthdate !== ""
      if (values) {
        setStepTwo(!stepTwo);
        setError("");
      } else {
    ...
    const handleSubmit = async (event) => {
      ...
      const values = formData.country !== "" && formData.email !== "" && formData.password !== ""
      if (values) {
          ...
          {!stepTwo ? (
            <>
              <div className="register-top">
                ...
                <select name="sex" value={formData.sex} onChange={handleInputChange} required className={formData.sex === "" ? "input select default" : "input select selected"}>
                  <option value="" className="default">Sexe</option>
                ...
                <div className="input-birthdate">
                  ...
                  <input
                      ...
                      onChange={handleInputChange}
                      className={formData.birthdate === "" ? "input default" : "input selected"}
                ...
                <div className="register-footer">
                  ...
                  <p className="bold">Etape {step}/2</p>
              </div>
            </>
          ) : (
            <>
              ...
              <div className="register-top">
                <select name="country" value={formData.country} onChange={handleInputChange} className={formData.country === "" ? "input select default" : "input select selected"}>
